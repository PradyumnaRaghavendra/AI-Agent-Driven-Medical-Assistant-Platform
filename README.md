...
<h1 align="center"><strong>⚕️ AI Agent-Driven Medical Assistant Platform<h6 align="center">agentic system for medical diagnosis and assistance</h6></strong></h1>
...
```bash
git clone https://github.com/PradyumnaRaghavendra/AI-Agent-Driven-Medical-Assistant-Platform
